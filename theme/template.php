  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. + (234) 8124027463</p>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          RMS<br></address>
          <p>
            <i class="icon-phone"></i> + (234) 8124027463 <br>
            <i class="icon-envelope-alt"></i> gloryoluwaseun68@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
